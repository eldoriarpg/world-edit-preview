...
import de.eldoria.preview.RenderConfiguration;
...
public class RenderSink {
    ...
    public RenderSink(Player sinkOwner, PacketWorker worker, RenderConfiguration configuration) {
    ...
    private int dispatchSend() {
        ...
        for (Player player : add) {
            if (newChanges == null || configuration.isOutOfRenderRange(player.getLocation(), newChanges.location())) continue;
        ...
        for (Player player : subscribers) {
            if (newChanges == null || configuration.isOutOfRenderRange(player.getLocation(), newChanges.location())) {
    ...
    private int update() {
        ...
        for (Player player : subscribers) {
            ...
            if (configuration.isOutOfRenderRange(player.getLocation(), newChanges.location())) {
                if (lastReceived.contains(player)) {
